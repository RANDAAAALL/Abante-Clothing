              ...
              <div className="flex justify-center items-center gap-0 sm:gap-5">
                ...
                <div className="flex flex-col justify-center space-y-2 sm:space-y-5">
                  {[
                    ...
                    <button className="cursor-pointer relative w-[90] h-[90] sm:w-[120] sm:h-[120]" key={index}
                      onClick={() =>{ router.push(`/products/${slug}/photo/${photoLinks.type}`, {scroll: false}); openPhotoModal()}}>
                      <Image
                        src={photoLinks.src}
