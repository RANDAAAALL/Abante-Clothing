...
export default function NavbarContent(){
    ...
    return (
        <>
           ...
           <div className={`${!isOpen ? "opacity-0" : isOpen} md:opacity-100 transition-opacity duration-300 ease-in-out w-full h-screen text-center bg-white-background gap-4 md:bg-transparent absolute top-0 left-0 z-1000 translate-x-0 translate-y-0 flex flex-col justify-center items-center md:flex md:flex-row md:space-y-0 md:gap-20 md:static md:block md:w-auto md:h-auto`}>
           <NavbarLinks />
