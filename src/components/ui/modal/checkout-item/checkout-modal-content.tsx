...
export default function CheckoutModalContent() {
  const { 
        ...
        computeItems,
        PaymentAndSaveInfo } = useCheckoutModal();
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/40">
      <div className={`bg-card-white-background dark:bg-card-black-background rounded-xl shadow-2xl w-[500px] max-w-[90%] sm:p-8 text-center space-y-6 transition-all duration-300`}>
        ...
        <div className="flex justify-center gap-4 pt-4">
          ...
          <>
          {PaymentAndSaveInfo.paymentMethod === "gcash" ? (
