...
export default function ProfileLayout({ children }: { children: React.ReactNode}){
    ...
    <div className="relative bg-white-card-background dark:bg-black-background dark:text-white text-black w-full max-w-[1980px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-[300px_1fr] md:gap-10 mt-10 w-full md:max-w-3xl mx-auto p-4 md:p-0">
        {/* sidebar */}
        <aside><SidebarContent /></aside>

        {/* right content */}
        <main className="mt-6 md:mt-16.5">{children}</main>
        </div>
    </div>
    );
}