...
export default function Register(){
    ...
    <div className="transition duration-500 ease-in-out bg-white dark:bg-black-background dark:text-white text-black  w-full max-w-[1980] mx-auto">
        ...
        <main className="flex justify-center items-center min-h-screen text-center w-full md:max-w-lg md:mx-auto p-4 md:p-6 ">
        <FormsContent<RegisterFormType> fields={registerFields} onSubmit={handleRegister} />
        </main>

        {/* footer section */}
        <footer className="font-regular text-sm w-full"><FooterSectionContent className="mt-15" styleName="pb-3 md:py-6"/></footer>
    </div>
    );
}